...
splits = np.load('chignolin_vamp_splits.npy')
...
tica_dims = ['95p', 2]
microstate_numbers = [50] + list(np.arange(100,1100,100))

scores = score_vamp_multiprocess(X, splits, tica_lags, tica_dims, microstate_numbers, 500, 32)

np.save('scores_msmlag100ns_splittica_alleigen', scores)
