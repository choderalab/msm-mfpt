...
splits = np.load('trpcage_vamp_splits.npy')
...
tica_lags = [1]
tica_dims = ['95p'] + [2,10,50,100,150]
microstate_numbers = [50,100,200,400,600,800,1000]

# data strided by 50 frames - lag time 1
scores = score_vamp_multiprocess(X, splits, tica_lags, tica_dims, microstate_numbers, 10, 32)
